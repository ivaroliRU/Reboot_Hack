module.exports.createEmail = function(link){
    ...
    <a href=${process.env.CONFIRM_LINK + id} tabindex="-1" target="_blank"><span style="font-size: 12px; line-height: 2; mso-line-height-alt: 24px;"><span style="font-size: 14px; line-height: 28px;">Verify your email</span></span><a/>
    </span></div>
