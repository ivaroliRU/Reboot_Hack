...
class SponsorImage extends Component {
  ...
  render() {
    ...
    return(
      ...
      <div className={style.image_center+(this.props.sponsorRank==4 ? " col-lg-2 "+style.col_sm_1_half : " col-lg-3")+" "+(this.props.sponsorName == null ? style.hide_on_small_screens : (this.props.sponsorRank==1 ? "col-12" : (this.props.sponsorRank==4 ? "col-4" : "col-6")))}>
