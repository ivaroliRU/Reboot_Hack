  ...
  render() {
    ...
    return (
      <div className={style.App}>
        ...
        <ParallaxScrollImage isThisDevideIOS={onIOS} imgDesktop={"/images/Index_second_photo_desktop-min.jpg"} imgMobile={"/images/Index_second_photo_mobile-min.jpg"} height={700}/>
